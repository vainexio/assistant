...
module.exports = {
  ...
  ai: {
    chatAI: async function (content, type, user, acc) {
      ...
      if (acc.name === "NUX") {
        let image_path =
          "https://media.discordapp.net/attachments/1150419141824610334";
        let images = [
          "NU_building: " +
            image_path +
            "/1150420555401539684/nu-laguna-hero.png",
          "Lecture_room: " +
            image_path +
            "/1150421391410208790/lecture-room2.jpg",
          "Psychology_Lab: " +
            image_path +
            "/1150421391712206948/Psychology-Laboratory.jpg",
          "Com_Lab: " + image_path + "/1150421390885912636/computer-lab-2.jpg",
          "Drawing_Room: " +
            image_path +
            "/1150421391133392927/Drawing-Room.jpg",
          "UTM_Lab: " + image_path + "/1150421390634262589/UTM-Laboratory.jpg",
          "Chem_Lab: " +
            image_path +
            "/1150421390378418216/Chemistry-Laboratory.jpg",
          "Library/LRC: " + image_path + "/1150422766504378440/library-2..jpg",
          "Auditorium: " + image_path + "/1150422766244352062/auditorium-4.jpg",
          "Chapel: " +
            image_path +
            "/1150425373096550490/IMG_20230910_213914.jpg",
          "Swimming_Pool: " +
            image_path +
            "/1150425373373378580/IMG_20230910_213804.jpg",
          "Canteen: " +
            image_path +
            "/1150425373646016533/IMG_20230910_213722.jpg",
          "Football_pitch: " +
            image_path +
            "/1150425373964771368/IMG_20230910_213644.jpg",
          "Gym: " + image_path + "/1150425374300319764/IMG_20230910_213612.jpg",
          "Hotel_rooms_&_dormitel: " +
            image_path +
            "/1150425374589734912/IMG_20230910_213528.jpg",
          "Medical_and_Dental_Clinic: " +
            image_path +
            "/1150424083444543539/IMG_20230910_213420.jpg",
          "Tennis_Court: " + image_path + "/1150423457906040952/IMG_0510.jpg",
          "Multi_Purpose_Center: " +
            image_path +
            "/1150423458669404170/ISA-MULTIPURPOSE-CENTER.jpg",
          "Hoops_Center: " +
            image_path +
            "/1150423459109797958/ISA-HOOPS-CENTER.jpg",
        ...
        let infos = [
          ...
          "Remember that the date and time today is " +
            currentDate +
            " remind this to the user whenever they ask",
      ...
      if (config.AI.modelCount >= config.AI.models.length)
        config.AI.modelCount = 0;
